...
const URGENCY_OPTIONS=[
  ...
  {id:'looking',label:'Присматриваюсь',sub:'РР·СѓС‡Р°СЋ РІР°СЂРёР°РЅС‚С‹'}
];
const STYLES=[
...
const PROCESS_STEPS=[
  ...
  {time:'Дни 5–15',title:'Производство',text:'РР·РіРѕС‚Р°РІР»РёРІР°РµРј РјРµР±РµР»СЊ РїРѕ СѓС‚РІРµСЂР¶РґС‘РЅРЅРѕРјСѓ РїСЂРѕРµРєС‚Сѓ.'},
...
const FAQ=[
  {q:'    ?',a:'Стоимость зависит от размеров, материалов и комплектации. На сайте показываем ориентировочный диапазон, а точную смету готовим после замера.'},
  {q:'     ?',a:'Да. До утверждения 3D-проекта можно корректировать планировку, материалы и детали.'},
  {q:'    ?',a:'Основные регионы — Алматы, Астана и область. Возможность работы в других городах уточнит менеджер.'},
  {q:'  ?',a:'Обычно 30–40 минут. Замер бесплатный и ни к чему не обязывает.'},
  {q:'  ?',a:'30% вносится на старте производства, остальные 70% — после установки и проверки мебели.'}
];
