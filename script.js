...
const CATEGORIES={
  ...
  hallway:{label:'Прихожая',step1Title:'Выберите тип прихожей',
    step1:[{id:'wardrobe-hanger',label:'Шкаф + вешалка'},{id:'wardrobe-mirror',label:'Шкаф + зеркало'},{id:'wardrobe-cabinet',label:'Шкаф со встроенным пуфиком'},{id:'full-set',label:'Полный комплект'}],
...
const REVIEWS=[
  {who:'Айгерим Т.',where:'ЖК Green Line, Алматы',text:'Кухня получилась ровно как в проекте. Особенно понравилось, что материалы показали заранее, а стоимость после согласования не менялась.'},
  {who:'Мурат С.',where:'Астана, район Есиль',text:'Гардеробную спроектировали под нестандартную нишу. Всё встало точно, монтаж закончили за один день.'},
  {who:'Дана К.',where:'Алматы, Бостандыкский район',text:'Понятная схема оплаты сняла опасения. После установки спокойно всё проверили и только потом внесли оставшуюся сумму.'}
];
const FAQ=[
